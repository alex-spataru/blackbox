...
/* Sometimes the FreeRTOScfg.h settings only allow a task to be created using
dynamically allocated RAM, in which case when any task is deleted it is known
that both the task's stack and TCB need to be freed.  Sometimes the
FreeRTOScfg.h settings only allow a task to be created using statically
allocated RAM, in which case when any task is deleted it is known that neither
the task's stack or TCB should be freed.  Sometimes the FreeRTOScfg.h
...
/*-----------------------------------------------------------*/
	...
	UBaseType_t uxReturn, uxSavedInterruptState;
		...
		is defined in FreeRTOScfg.h then
...
UBaseType_t uxSavedInterruptStatus;
	...
	FreeRTOS API functions.  If configASSERT() is defined in FreeRTOScfg.h
...
/*----------------------------------------------------------*/
	...
	uint32_t ulTotalTime, ulStatsAsPercentage;
		...
		#if( configUSE_TRACE_FACILITY != 1 )
		{
			#error configUSE_TRACE_FACILITY must also be set to 1 in FreeRTOScfg.h to use vTaskGetRunTimeStats().
		}
		#endif
